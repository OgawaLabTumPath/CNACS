...
echo "rm ${OUTPUTDIR}/${ID}/${ID}_diploid_region.high_res.txt"
rm ${OUTPUTDIR}/${ID}/${ID}_diploid_region.high_res.txt
...
do
	...
	echo "${PERL_PATH} ${COMMAND_CNACS}/subscript_exome/norm_depth_adjust.pl ${OUTPUTDIR}/${ID}/tmp/segment_tmp.all.txt ${OUTPUTDIR}/${ID}/tmp/merged_signal.all.txt ${PAR_BED} ${REGION} ${PLOIDY} ${OUTPUTDIR}/${ID}/tmp/result_tmp.all.txt ${OUTPUTDIR}/${ID}/tmp/proc_signal.all.txt ${OUTPUTDIR}/${ID}/tmp/summary.all.txt"
	${PERL_PATH} ${COMMAND_CNACS}/subscript_exome/norm_depth_adjust.pl ${OUTPUTDIR}/${ID}/tmp/segment_tmp.all.txt ${OUTPUTDIR}/${ID}/tmp/merged_signal.all.txt ${PAR_BED} ${REGION} ${PLOIDY} ${OUTPUTDIR}/${ID}/tmp/result_tmp.all.txt ${OUTPUTDIR}/${ID}/tmp/proc_signal.all.txt ${OUTPUTDIR}/${ID}/tmp/summary.all.txt
	check_error $?
