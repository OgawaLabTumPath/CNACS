...
do
	...
	echo "${PERL_PATH} ${COMMAND_CNACS}/subscript_exome/norm_depth_adjust.pl ${OUTPUTDIR}/${ID}/tmp/segment_tmp.txt ${OUTPUTDIR}/${ID}/tmp/merged_signal.txt ${PAR_BED} ${REGION} ${PLOIDY} ${OUTPUTDIR}/${ID}/tmp/result_tmp.txt ${OUTPUTDIR}/${ID}/tmp/proc_signal.txt ${OUTPUTDIR}/${ID}/tmp/summary.txt"
	${PERL_PATH} ${COMMAND_CNACS}/subscript_exome/norm_depth_adjust.pl ${OUTPUTDIR}/${ID}/tmp/segment_tmp.txt ${OUTPUTDIR}/${ID}/tmp/merged_signal.txt ${PAR_BED} ${REGION} ${PLOIDY} ${OUTPUTDIR}/${ID}/tmp/result_tmp.txt ${OUTPUTDIR}/${ID}/tmp/proc_signal.txt ${OUTPUTDIR}/${ID}/tmp/summary.txt
	check_error $?
